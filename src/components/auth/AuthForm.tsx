  ...
  return (
    <div className="w-full max-w-md mx-auto p-6 bg-card rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          {isLoading ? "Loading..." : type === "signin" ? "Sign In with Email" : "Sign Up with Email"}
        </button>
      </form>
      ...
      <button
        ...
        disabled={isLoading}
        className="w-full py-2 px-4 bg-secondary text-secondary-foreground rounded-md hover:bg-secondary/90 transition-colors disabled:opacity-50 flex items-center justify-center"
      >
